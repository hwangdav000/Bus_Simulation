...
bool rLocalSimulator::Start() {
  ...
  Stop * stop_CC_WB_2 =
  new Stop(9, 44.984482, -93.181657);  //  Buford & Gartner
  Stop * stop_CC_WB_3 =
  new Stop(10, 44.983703, -93.178846);  //  Fairgrounds
  Stop * stop_CC_WB_4 =
  new Stop(11, 44.980663, -93.180808);  //  Tway
  Stop * stop_CC_WB_5 =
  new Stop(12, 44.976397, -93.221801);  //  before transit
  Stop * stop_CC_WB_6 =
  new Stop(13, 44.978058, -93.229176);  //  Ridder
  Stop * stop_CC_WB_7 =
  new Stop(14, 44.978366, -93.236038);  //  Jones-Eddy
  Stop * stop_CC_WB_8 =
  new Stop(15, 44.974549, -93.236927);  //  Bruininks
  Stop * stop_CC_WB_9 =
  new Stop(16, 44.972638, -93.243591);  //  Blegen
